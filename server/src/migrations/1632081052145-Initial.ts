...
export class Initial1632081052145 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "board" ("slug" character varying NOT NULL, "title" character varying NOT NULL, "creatorId" uuid NOT NULL, "description" character varying NOT NULL, "adjustable" boolean NOT NULL, "angles" smallint array NOT NULL, "location" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_24d1b2169cb24fb2d3ff812a4e0" UNIQUE ("title"), CONSTRAINT "PK_ae7bfe48cb8fca88f4f99f13125" PRIMARY KEY ("slug"))`);
        ...
        await queryRunner.query(`ALTER TABLE "problem" ADD CONSTRAINT "FK_ac86a7f16bfd5c83c876e5111d1" FOREIGN KEY ("boardSlug") REFERENCES "board"("slug") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "layout" ADD CONSTRAINT "FK_841bf9725e5ada0d76538d17844" FOREIGN KEY ("boardSlug") REFERENCES "board"("slug") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "ascent" ADD CONSTRAINT "FK_61823d6f4483c36b770608414d1" FOREIGN KEY ("boardSlug") REFERENCES "board"("slug") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "ascent" DROP CONSTRAINT "FK_61823d6f4483c36b770608414d1"`);
        ...
        await queryRunner.query(`ALTER TABLE "layout" DROP CONSTRAINT "FK_841bf9725e5ada0d76538d17844"`);
        ...
        await queryRunner.query(`ALTER TABLE "problem" DROP CONSTRAINT "FK_ac86a7f16bfd5c83c876e5111d1"`);

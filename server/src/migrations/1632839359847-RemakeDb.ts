...
export class RemakeDb1632839359847 implements MigrationInterface {
  name = 'RemakeDb1632839359847';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "problem" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "creatorId" uuid NOT NULL, "title" character varying NOT NULL, "rules" character varying NOT NULL, "angle" integer NOT NULL, "coordinates" jsonb NOT NULL, "grade" integer NOT NULL, "rating" integer, "boardId" uuid NOT NULL, "layoutUrl" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "layoutId" uuid, CONSTRAINT "REL_5f1a67c1ec436bff1608eefe36" UNIQUE ("layoutId"), CONSTRAINT "PK_119b5ca6f3371465bf1f0f90219" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "layout" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "description" character varying NOT NULL, "url" character varying NOT NULL, "creatorId" uuid NOT NULL, "boardId" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_6e288ce489327c1ec1274d24942" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "board" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "creatorId" uuid NOT NULL, "description" character varying NOT NULL, "adjustable" boolean NOT NULL, "angles" smallint array NOT NULL, "location" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_24d1b2169cb24fb2d3ff812a4e0" UNIQUE ("title"), CONSTRAINT "PK_865a0f2e22c140d261b1df80eb1" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "problem" ADD CONSTRAINT "FK_55d7542020ecd4a1b1911615c56" FOREIGN KEY ("boardId") REFERENCES "board"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "layout" ADD CONSTRAINT "FK_2eee24c303c78eed1938d3f3f04" FOREIGN KEY ("boardId") REFERENCES "board"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "ascent" ADD CONSTRAINT "FK_64592940c5c1ee59433d148d977" FOREIGN KEY ("boardId") REFERENCES "board"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "ascent" DROP CONSTRAINT "FK_64592940c5c1ee59433d148d977"`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "layout" DROP CONSTRAINT "FK_2eee24c303c78eed1938d3f3f04"`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "problem" DROP CONSTRAINT "FK_55d7542020ecd4a1b1911615c56"`
    );
    await queryRunner.query(
